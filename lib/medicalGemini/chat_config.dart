class MedicalChatConfigs {
  ...
  static const String welcomeMessage = "Olá 👋 Estou aqui para ajudar com duvidas medicas. Como posso te ajudar hoje?";
  ...
  static const String systemInstruction = "Você é um assistente médico profissional de saúde."
